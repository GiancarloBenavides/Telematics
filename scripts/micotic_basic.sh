...
# Crear el bridge para conectar todos los puertos de la LAN (8)
#----------------------------------
...
# Direccionamiento de las interfaces (9)
#----------------------------------
...
# Crear el pool de direcciones que servira para asignar DHCP (10)
#----------------------------------
/ip pool add name=pool_dhcp_lan ranges=192.168.100.100-192.168.100.200
# Crear servidor DHCP (11)
#----------------------------------
...
# Crear un direccionamiento estatico para el servidor web (12, 13)
#----------------------------------
...
# Crear una regla de source NAT para permitir que los equipos de la LAN tengan internet (14)
#----------------------------------
/ip firewall nat add chain=srcnat action=masquerade out-interface="ether3"
# Crear una regla de destination NAT para permitir que los equipos de la WAN accedan a un servidor en la LAN (15)
#----------------------------------
